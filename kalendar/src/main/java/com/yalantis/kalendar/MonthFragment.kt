...
//import com.yalantis.kalendar.view.Day
//import com.yalantis.kalendar.view.Kalendar
//import com.yalantis.kalendar.view.Month
//import java.util.*
//
//class MonthFragment : Fragment(), ViewProvider, Day.OnDayClickListener, DateView {
//
...
//
//    var listener: Kalendar.KalendarListener? = null
//
//    @DrawableRes
...
//            moveManager.expand()
//        } else {
//            (view as ViewGroup).applyTransition {
//                if (forward) {
...
//        if (isCreated.not()) {
//            calculateBounds(rootView.left, rootView.top, rootView.right, rootView.bottom)
//            rootView.setBackgroundResource(android.R.color.white)
//            setDate(dateManager.getCurrentDate())
//
//            rootView.layoutParams = rootView.layoutParams.apply { height = ViewGroup.LayoutParams.WRAP_CONTENT }
//
//            isCreated = true
//        }
//    }
...
//        var week: ViewGroup
//        var day: Day
//        for (i in WEEK_OFFSET until rootView.childCount) {
//            week = rootView.getChildAt(i) as ViewGroup
//            for (j in 0 until week.childCount) {
//                day = week.getChildAt(j) as Day
//                if (day.date == date) {
//                    rootView.post { applyDaySelection(day) }
//                    return
//                }
//            }
//        }
...
//            clickListener = this@MonthFragment
...
//            val selectedWeek = rootView.indexOfChild(parent) - WEEK_OFFSET
...
//        rootView = LinearLayout(context).apply { orientation = LinearLayout.VERTICAL }
//        createMonthSwitch()
//        createWeekDays()
...
//                totHeight += rootView.getChildAt(i).height
//            }
//            rootView.layoutParams = rootView.layoutParams.apply { height = ViewGroup.LayoutParams.WRAP_CONTENT }
...
//            when (i) {
//                1 -> rootView.addView(createWeek(daysBefore, true))
//                weeksAmount -> rootView.addView(createWeek(daysAfter, false))
//                else -> rootView.addView(createWeek(0, false))
//            }
//        }
//    }
//
...
//            this.layoutParams = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dragHeight)
//        })
//        rootView.getChildAt(rootView.childCount - 1).layoutParams = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dragHeight).apply {
